  ...
  return (
    ...
    <nav className="navbar">
        ...
        <div className="desktopMenu">
            ...
            <Link activeCslass='active' to='skills' spy={true} smooth={true} offset={-50} duration={500} className="desktopMenuListItem">About</Link>
        ...
        <div className="navMenu menu" style={{display:showMenu? 'grid' : 'none'}}>
